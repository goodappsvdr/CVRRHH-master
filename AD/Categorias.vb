...
Public Class Categorias
    ...
    Public Function BuscarPorCategoriatipoBEWeb(ByVal Categoriatipo As String) As DataSet

        Try

            Return oDatabase.ExecuteDataSet("Categorias_BuscarPorCategoriaTipoBEWeb", Categoriatipo)
