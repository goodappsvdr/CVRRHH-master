Partial Class RptFormacionAcademica
    ...
    Private Sub InitializeComponent()
        ...
        Me.TextBox5.Value = "= Fields.NivelAcademico"
        '
        'TextBox6
        '
        ...
        Me.TextBox6.Value = "Nivel académico:"
        '
        'TextBox7
        '
        ...
        Me.TextBox8.Value = "= Fields.Institucion"
        '
        'TextBox9
        '
        ...
        Me.TextBox9.Value = "= Fields.Especialidad"
        '
        'TextBox10
        '
        ...
        Me.TextBox10.Value = "Especialidad:"
        '
        'SqlDataSource1
        '
