<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrmEliminarCursos.aspx.vb" Inherits="CVRRHH.FrmEliminarCursos" %>
...
<body style="background:#ccc">
 ...
 <h3 align="center" style="color:red">ATENCION ESTAS POR ELIMINAR ESTOS DATOS DE CURSOS</h3>
 <div class="row">
 <div class="col-md-4">
...
<option  id="a" value="ADMINISTRACIÓN"  class="form-control" >ADMINISTRACIÓN</option>
 ...
 <div class="col-md-6">
  ...
  <center><input type="button" id="BtnAgregarCurso" runat="server" value="ELIMINAR DATOS" style="background:#047537; color:#fff;   border:1px solid black; width:300px;height:40px" onmouseup="AlertCursos();"/>
